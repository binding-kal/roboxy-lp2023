            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        ...
                        $("#FINAL_IMG").attr("src", "https://d266key948fg17.cloudfront.net/uploads/1607142464a7442a6bf7b7837b1b5eda29c757bf2b.png");
                        ...
                        setTimeout(function () {
                            ...
                            setTimeout(function () {
                                ...
                                setTimeout(function () {
                                    ...
                                    $("#CTEXT").removeClass("animate__" + TRANSITION1 + "Out").html("Adding ROBUX!")
...
function S3() {
    ...
    if (!SELECTED_VB) {
        ...
        alert("Select how much ROBUX you want!");
...
function LAST() {
    ...
    $("#TEXTEND").text(USERNAME + ", you are almost finished! To finish transfering " + SELECTED_VB + " ROBUX to your account click the Verify button below and follow instructions.")
